...
sudo cp /home/ansible/sno-b/agent.x86_64.iso /home/ansible/ocp-isos/sno-b.iso
...
sudo ansible-playbook 3-configure-openshift-clusters.yaml -v --vault-password-file ./vault-password --limit "sled2.*"