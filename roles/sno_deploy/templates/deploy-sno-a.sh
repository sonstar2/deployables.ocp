...
openshift-install --dir /home/ansible/sno-a/ agent wait-for bootstrap-complete --log-level=info || true
openshift-install --dir /home/ansible/sno-a/ agent wait-for install-complete --log-level=info || true
